...
module.exports.fetchFiles = function (dbFolder, dbName) {
    if (!fs.existsSync(dbFolder)) {
        ...
        if (!fs.existsSync(`./${dbFolder}/${dbName}.bson`)) {
            fs.writeFileSync(`./${dbFolder}/${dbName}.bson`, bson.serialize({}));

            return;
        };
    } else {
        if (!fs.existsSync(`./${dbFolder}/${dbName}.bson`)) fs.writeFileSync(`./${dbFolder}/${dbName}.bson`, bson.serialize({}));
    }
};
