    ...
    async execute(interaction) {
        ...
        if (kazma === 'mzrdemirkazma') {
            ...
            if (fiyat > bakiye || !bakiye) {
                return interaction.editReply({ content: `> Cüzlanında bu kadar para yok! Bu kazmayı alabilmen için **${fiyat} BL**'ye ihtiyacın var.\n> **Mevcut paran:** ${bakiye} BL`, ephemeral: true });
            };
            ...
            .setDescription(`**${fiyat} BL** vererek bir **Demir Kazma** satın aldın!`)
            .setColor('Green')
            .setTimestamp()
            ...
            const mzrEmbed = new EmbedBuilder()
            .setTitle('Satın Aldın ✅')
            .setDescription(`**${fiyat} BL** vererek bir **Elmas Kazma** satın aldın!`)
            .setColor('Green')
            .setTimestamp()
            .setFooter({ text: 'discord.gg/mzrdev', iconURL: user.displayAvatarURL() })
